            ...
            className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {PLANS_CONTENT.plans.map((plan, index) => (
                  ...
                  className={`p-8 rounded-xl shadow-lg bg-neutral-950 ${
                    plan.popular ? "border border-purple-900/80" : "border border-neutral-800"
                  }`}>
                    {plan.popular && (
                        <div className="text-center mb-4">
                            <span className="bg-green-600 text-white text-xs py-1 px-3 rounded-full uppercase">
                    ...
                    <button className="w-full py-3 bg-purple-600 hover:bg-green-500 rounded-lg">
