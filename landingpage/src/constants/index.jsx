...
import student1 from "../assets/user1.jpeg";
import student2 from "../assets/user2.jpeg";
import student3 from "../assets/user3.jpeg";
...
export const HERO_CONTENT = {
  badgeText: "🚀 Learnify 2.0",
  mainHeading: "The Ultimate \n Learning Tool",
  subHeading:
    "Enhance your learning experience with AI—upload study materials, get real-time summaries, quizzes, and interactive chats, all in one platform. Perfect for students seeking smarter, faster study tools.",
  callToAction: {
    primary: "Get Stared",
    secondary: "Login",
  },
